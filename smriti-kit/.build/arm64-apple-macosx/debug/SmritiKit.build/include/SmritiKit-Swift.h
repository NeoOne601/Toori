...
#ifndef SMRITIKIT_SWIFT_H
#define SMRITIKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SmritiKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class PHChange;
SWIFT_CLASS("_TtC9SmritiKit18SmritiPhotoLibrary")
@interface SmritiPhotoLibrary : NSObject <PHPhotoLibraryChangeObserver>
